/** Breeder email validation — used by outreach API and CLI scripts. */
...
function isValidBreederEmail(email) {
...
function normalizeBreederEmail(email) {
...
module.exports = { isValidBreederEmail, normalizeBreederEmail, SKIP_EMAILS };
