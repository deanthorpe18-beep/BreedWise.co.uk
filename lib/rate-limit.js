...
// On Vercel (serverless) each instance keeps its own counters, so this is a
// best-effort throttle per lambda rather than a global limit — good enough to
// blunt bursts/abuse without adding Redis. TTL cleanup prevents memory leaks.
